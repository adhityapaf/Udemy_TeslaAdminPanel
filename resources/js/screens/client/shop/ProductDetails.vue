<template>
    <div style="background-color:white" class="mt-5">
        <v-container>
            <div class="row">
                <div class="col-md-5 col-sm-5 col-xs-12">
                    <v-img style="height:500px" :src="'/products/'+product.image"></v-img>
                </div>
                ...
                <div class="col-sm-12 col-xs-12 col-md-12">
                    ...
                    <v-card-text class="pa-0 pt-4" tile outlined>
                        ...
                        <div class="row text-center">
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" v-for="productItem in products" :key="productItem.id">
                                <v-hover v-slot:default="{hover}" open-delay="240">
                                    <v-card :elevation="hover ? 16 : 2">
                                        <v-img :src="'/products/'+productItem.image" class="white--text align-end" height="200px" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)">
