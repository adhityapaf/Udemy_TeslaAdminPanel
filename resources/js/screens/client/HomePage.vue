    ...
    <v-container fluid class="promo">
      <v-content>
        <div class="text-center" style="margin-top: 13%">
          <h1 class="display-2">Go Electric</h1>
          <h1 class="display-1">Save The Planet</h1>
        </div>
      </v-content>
    </v-container>
    <v-container
      ...
      <v-row style="margin-top: 60px">
        ...
        <v-col cols="6" class="white--text" style="align-self: center">
          <div class="ml-4" style="width: 36%">
            <span style="font-size: 23px" class="mb-2"> Wireless Gaming </span>
            <br />
            <span>
...
<style>
 .promo {
     background : url('/assets/tesla-model-x.jpeg');
     background-size: cover;
     width: 100%;
     height: 100vh;
 }
  .background {
     background: url('/assets/tesla-core-features-background.jpg');
     background-size: cover;
     width: 100%;
     height: 70vh;
 }
